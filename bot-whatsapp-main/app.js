...
app.post('/noMissing', (req, res) => {
    console.log(req.query.phone)
    client.sendMessage(req.query.phone+'@c.us', 'Buenas! hoy termina tu servicio: '+req.query.service+', si deseas continuar con él es necesario que realices el pago a su numero de cuenta, en caso de ser depósito o si es por medio de transferencia a la cuenta {CUENTA_TRANSFERENCIA}te recuerdo que tu plan actual es $'+req.query.pay+'.')
})

app.post('/welcome', (req, res) => {
    console.log(req.query.phone)
    var messageWelcome = "Gracias por contratar el servicio "+req.query.service+", ya fue registrado en el sistema, por favor de agendar este numero ya que por este medio se le recordara sus proximos pagos y brindara soporte de su servicio." 
    client.sendMessage(req.query.phone+'@c.us', messageWelcome)
})
